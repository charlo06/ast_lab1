...
(function() {
  ...
  module.exports = {
    logic: function(req, res) {
      var fileContents, img, img2, img3, img4, img5, img6, img7, img8;
      console.log(req.url);
      if (req.url === '/') {
        fs.readFile('./lib/html/index.html', function(err, data) {
          res.writeHead(200, {
        ...
        fs.readFile('./lib/html/about.html', function(err, data) {
          res.writeHead(200, {
            'Content-Type': 'text/html'
          });
          res.write(data);
        ...
        fileContents = fs.readFileSync('./lib/css/style.css', {
          encoding: 'utf8'
        });
